...
enum custom_keycodes {
    ...
    FWVER = SAFE_RANGE, 
    GIT_ST, // git status
    GIT_DV, // git switch develop
    GIT_UP, // git update (fetch/pull/subup)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_GIT] = LAYOUT_ansi_82(
        _______,  _______,  GIT_ST,     GIT_DV,     GIT_UP,     _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,            _______,
        _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [LAYER_FN]        = { ENCODER_CCW_CW(KC_VOLD,       KC_VOLU)},
